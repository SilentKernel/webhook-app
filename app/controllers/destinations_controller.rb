...
class DestinationsController < ApplicationController
  ...
  before_action :set_destination, only: [ :show, :edit, :update, :destroy, :edit_modal, :update_modal ]
  before_action :load_org_members, only: [ :new, :edit, :create, :update, :new_modal, :create_modal, :edit_modal, :update_modal ]
